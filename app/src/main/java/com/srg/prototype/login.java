...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currCode = BuildConfig.VERSION_CODE;
        new getversion().execute();
        //   currVersion = Integer.toString(currCode).trim();
        //typecasting values
...
//
    ...
    public class getversion extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            db_url = "http://acosaf.000webhostapp.com/versioncheck.php";
...
//
        ...
        protected void onPostExecute(String s) {
            if (currCode < getCode) {
                apk_updateDialog dialog = new apk_updateDialog();
